...
//----------------------------------------------------------------------------------
howto_demod_filterbank_ccvc_sptr howto_make_demod_filterbank_ccvc (unsigned int numvec, unsigned int M, unsigned int L, unsigned int K, unsigned int P, unsigned int Q, int pulsetype, double beta)
{
	return howto_demod_filterbank_ccvc_sptr(new howto_demod_filterbank_ccvc(numvec, M, L, K, P, Q, (gr_cpm::cpm_type)pulsetype, beta));
}
